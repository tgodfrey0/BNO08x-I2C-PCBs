// Generated by SolidPython 1.1.3 on 2023-07-03 09:23:24
$fa = 0.4; $fs = 0.4;
...
rotate(a = 0, v = [1, 0, 0]) {
	difference() {
			...
			difference() {
				linear_extrude(height = 1.8500000000) {
					offset(r = 1.0000000000) {
						import(file = "/home/tgodfrey/projects/bno085-i2c/hardware/bno085-i2c-board-v3-panel/stencils/bno085-i2c-board-v3-panel-EdgeCuts.dxf", origin = [0, 0]);
					}
				}
		...
		linear_extrude(center = true, height = 0.6000000000) {
			translate(v = [0, 0, 0]) {
				import(file = "/home/tgodfrey/projects/bno085-i2c/hardware/bno085-i2c-board-v3-panel/stencils/bno085-i2c-board-v3-panel-PasteBottom.dxf", origin = [0, 0]);
			}
		}
	}
}
